...
export default function TrackingScreen() {
    // Координаты — центр Парижа (около Нотр-Дам)
    ...
    // Начальная позиция курьера —  район Марэ
    ...
    useEffect(() => {
        ...
        Animated.timing(animatedValue, {
            toValue: 1,
            duration: 15000, // 15 секунд — имитация доставки
            useNativeDriver: false,
        }).start();

        //  координаты курьера плавно
    ...
    const routeCoords = [courierLocation, clientLocation];
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.buttonsRow}>
                ...
                <Pressable style={[styles.actionButton, { backgroundColor: "#FF3B30" }]}>
